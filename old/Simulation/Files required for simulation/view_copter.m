function [] = view_copter(x,y,z,roll,pitch,yaw)
%plots copter 
...
if isempty(first)
    [~,SQR,motorColor,propColor] = build_quad();  %global coords
    load('goliath_xy.mat');
...
% % [ sp*sy + cp*cy*sr, cy*sp - cp*sr*sy,  cp*cr]
...
trans = A*origGoliath'; %   4x4 A*orig nx4
...
hold on
    ...
    plot(0,0,'+','MarkerEdgeColor','r','MarkerSize',15)
