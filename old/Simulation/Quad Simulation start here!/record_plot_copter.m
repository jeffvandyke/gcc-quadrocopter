function [] = record_plot_copter(x,y,z,roll,pitch,yaw)
%plots copter 
...
hold on
    ...
    xplot = subplot(30,3,76);
    yplot = subplot(30,3,77);
    zplot = subplot(30,3,78);
...
axis(xplot,[-.500,.500,-1,1])
axis(yplot,[-.500,.500,-1,1])
axis(zplot,[0,2,-1,1])
